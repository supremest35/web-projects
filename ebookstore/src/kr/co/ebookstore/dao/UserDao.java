...
public class UserDao {
	...
	private static final String GET_USER_BY_ID_SQL = "select * from ebookstore_users where user_id = ?";
	private static final String INSERT_USER_SQL = "insert into ebookstore_users(user_id, user_password, user_name, user_tel, user_email)"
												+ " values(?, ?, ?, ?, ?)";
